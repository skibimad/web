...
-- Use INSERT IGNORE to prevent duplicate key errors on re-run
...
-- Insert demo heroes
-- Use INSERT IGNORE to prevent duplicate key errors on re-run
INSERT IGNORE INTO heroes (slug, name, description, image, video, abilities, display_order) VALUES
...
-- Use INSERT IGNORE to prevent duplicate key errors on re-run
INSERT IGNORE INTO episodes (episode_number, title, description, thumbnail, video_url, duration, release_date) VALUES
...
-- Use INSERT IGNORE to prevent duplicate key errors on re-run
INSERT IGNORE INTO blog_posts (title, slug, content, excerpt, image, author, published) VALUES
...
-- Use INSERT IGNORE to prevent duplicate key errors on re-run
INSERT IGNORE INTO landing_content (section, title, subtitle, content) VALUES
